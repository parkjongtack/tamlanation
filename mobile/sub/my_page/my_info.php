    ...
    <div class="mypage_inner join_outer">
        ...
        <form action="../action/write_action.php" class="join_form" method="POST" onsubmit="return member_insert_action();">
            ...
            <ul>
                ...
                <li>
                    <p>대표자 핸드폰</p>
                    <input type="text" class="phone" name="user_phone1" value="<?=substr($row['user_phone'],0,3)?>"> - <input type="text" class="phone" name="user_phone2" value="<?=substr($row['user_phone'],4,4)?>"> - <input type="text" class="phone" name="user_phone3" value="<?=substr($row['user_phone'],9,4)?>">
                </li>
                <li>
                    <p>은행명&예금주</p>
                    <input type="text" class="email" name="user_bank" value="<?=$row['user_bank']?>"> <input type="text" class="email" name="user_bank_name" value="<?=$row['user_bank_name']?>">
                </li>
                <li>
                    <p>은행 계좌번호</p>
        ...
        <form action="../action/write_action.php" class="join_form" method="POST" onsubmit="return member_insert_action();">
            ...
            <ul>
                ...
                <li>
                    ...
                    <input type="text" class="email" name="user_email1"> @ <input type="text" class="email" name="user_email2">
                </li>
            </ul>
            <div class="submit_box">
                <input type="submit" value="수정하기">
