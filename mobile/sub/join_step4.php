            ...
            <ul>
                ...
                <li>
                    ...
                    <select name="user_sectors" required>
						<option value="gas_station">주유소정보</option>
						<option value="mart">마트정보</option>
						<option value="motel">숙박정보</option>
						<option value="restaurant">음식점정보</option>
						<option value="marketplace">장터정보</option>
						<option value="etc">기타정보</option>
                    </select>
                </li>
                <li>
                    <p>매장 이름</p>
                    <input type="text" name="user_store_name" required>
                </li>
                <li>
                    <p>매장 우편번호</p>
                    <input type="text" id="user_address_number" name="user_address_number" required onclick="javascript:sample4_execDaumPostcode();">
					<span class="id_check" onclick="javascript:sample4_execDaumPostcode();">주소찾기</span>
                </li>
                <li>
                    <p>매장 기본주소</p>
                    <input type="text" id="user_address" name="user_address" required readonly onclick="javascript:sample4_execDaumPostcode();">
                </li>
                <li>
                    <p>매장 상세주소</p>
                ...
                <li>
                    <p>매장 일반전화</p>
                    <input type="text" name="user_store_call" required>
                </li>
                <li>
                    <p>사업자등록번호</p>
                    <input type="text" name="user_business_number" required>
                </li>
                <li>
                    <p>대표자 이름</p>
                ...
                <li>
                    <p>대표자 핸드폰</p>
                    <input type="text" class="phone" name="user_phone1" required> - <input type="text" class="phone" name="user_phone2" required> - <input type="text" class="phone" name="user_phone3" required>
                </li>
                <li>
                    <p>은행명&예금주</p>
                    <input type="text" class="email" name="user_bank" required> <input type="text" class="email" name="user_bank_name" required>
                </li>
                <li>
                    <p>은행 계좌번호</p>
                    <input type="text" name="user_bank_info" required>
                </li>
                <li>
                    <p>홈페이지 주소</p>
                ...
                <li>
                    <p>매장 오픈날짜</p>
                    <input type="text" name="user_store_opendate" required>
                </li>
                <li>
                    <p>매장 소개글</p>
