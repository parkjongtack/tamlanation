...
<div class="sub_nav_outer">
    ...
    <ul>
        <li>TRK 가맹점이란?</li>
        <li>
            <div class="on"><a href="/sub/franchisee/apply.php">TRK 가맹점이란?</a></div>
            <div><a href="/sub/franchisee/franchisee.php?user_sectors=gas_station">가맹점 리스트</a></div>
        </li>
    </ul>
</div>
<div class="sub sub_outer inner">
    <img src="/img/sub3_1.png" alt="">
</div>
<script>
