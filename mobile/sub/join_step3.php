    ...
    <div class="join_outer">
        ...
        <form action="/action/write_action.php" class="join_form" method="POST" onsubmit="return member_insert_action();">
            ...
            <ul>
                ...
                <li>
                    <p>연락처</p>
                    <input type="text" class="phone" name="user_phone1" required> - <input type="text" class="phone" name="user_phone2"> - <input type="text" class="phone" name="user_phone3" required>
                </li>
                <li>
                    <p>이메일</p>
                    <input type="text" class="email" name="user_email1" required> @ <input type="text" class="email" name="user_email2" required>
                </li>
            </ul>
