...
<div class="main_slider swiper-container">
    <div class="swiper-wrapper">
        <div class="swiper-slide">
            <img src="/img/m_main_slide_img01.png" alt="슬라이드1">
        </div>
        <div class="swiper-slide">
            <img src="/img/m_main_slide_img02.png" alt="슬라이드2">
        </div>
    </div>
    ...
    <div class="inner">
        ...
        <div class="franchise_area">
            <div class="fran_title">
                <p>가맹점</p>
                <h2>FRANCHISE</h2>
                <span>탐라국의 다양한 가맹점들을 안내해드립니다.</span>
                <a href="#none" class="read_more"><img src="/img/fran_read_btn.png" alt=""></a>
            </div>
