    ...
    <div class="join_outer">
        ...
        <form action="../action/write_action.php" class="join_form" method="POST" onsubmit="return member_insert_action();">
            ...
            <ul>
                ...
                <li>
                    <p>대표자 핸드폰</p>
                    <input type="text" name="user_phone1" required> - <input type="text" name="user_phone2" required> - <input type="text" name="user_phone3" required>
                </li>
                <li>
                    <p>은행명&예금주</p>
                    <input type="text" name="user_bank" required> <input type="text" name="user_bank_name" required>
                </li>
                <li>
                    <p>은행 계좌번호</p>
